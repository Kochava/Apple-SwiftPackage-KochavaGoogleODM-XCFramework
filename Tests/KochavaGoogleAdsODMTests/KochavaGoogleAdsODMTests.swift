...
final class KochavaGoogleODMTests: XCTestCase
{
    ...
    func test_witnessAllKnownProductRegistrationLogMessages()
    {
        ...
        // TEST
        // KVALog.shared.level
        // ⓘ Set to trace.  This will result in the KVANetworkingProduct being registered, and this will be prefaced by any other known modules which are included.  This will be printed to the log where they can be inspected.
        Log.shared.level = .trace
